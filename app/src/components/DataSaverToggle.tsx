  ...
  return (
    ...
    >
      ...
      <span className="flex-1">
        <span className="block text-base font-medium text-slate-900">Data qənaəti</span>
        <span className="block text-xs text-slate-500">Peyk təbəqəsini avtomatik yükləmə (3G-də sərfəli)</span>
      </span>
