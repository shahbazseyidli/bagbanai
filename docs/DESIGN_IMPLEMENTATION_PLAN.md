...
- **D2 qalan (3-cü dilim — brauzer-test tələb edir):** D2.2 "Bu gün" kart ana ekranı (hava+alert+verdict kartlar) · D2.3-full tam-ekran xəritə + sürüşən 3-snap sheet (drag fizikası) · D2.4 Ətraflı analiz sensor-birləşmə · D2.6 kamera FAB foto-axını · desktop sidebar. Bunlar `?ui=v2` altında paralel qurulub sınaqdan keçirilməlidir.
