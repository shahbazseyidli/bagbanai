...
- **Növbəti:** D3 onboarding hunisi; qalan funksional **T18** (RU/TR — böyük i18n sweep) · **T14** (subsidiya tarixçə UI); **bloklanan** T15 (STT provayder qərarı) · T20/T21 (Faza-3/4 XL) · T22/T23/T26 (Telegram token) · T25 (U12 hüquqi). **⏳ 2 yeni cron crontab-a əlavə olunmalı** (enqueue-research-seasonal + compute-season-features — yuxarı Cron-lar bölməsi).
