...
from .routers import (admin, advice, auth, chat, events, farms, fertilizer, fields, geo, health,
                      indices, internal, knowledge, ledger, messaging, mgmt, orgs, photos, providers,
                      scouting, uploads)
