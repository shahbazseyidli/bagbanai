...
WELCOME_EXTRA = {
  ...
  "ru": {
    "farmer": {
      ...
      "intro": [
        "Меня зовут Ülkər, я из команды Agradex. Agradex — ваш <b>помощник на базе спутников и AI</b>: видеть каждое поле из космоса, вовремя замечать стресс и вести счёт каждому манату.",
        "Начнём за два шага:"
      ],
      "steps": [
        {
